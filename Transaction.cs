...
namespace LibraryManagement
{
    public partial class Transaction : Form
    {
        ...
        private void PopulateDataGridView()
        {
            ...
            string query = "SELECT * FROM transaction"; // Assuming "transactions" is the name of your table
        ...
        {
            // Create an OpenFileDialog to select the existing Excel file
        ...
        // Optional: If you want to handle the CellContentClick event
        ...
        {
            // Add your About button click event handling code here
        }
